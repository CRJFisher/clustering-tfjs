...
export const sigmoid: typeof tfTypes.sigmoid = (...args) => tf.sigmoid(...args);
export const log: typeof tfTypes.log = (...args) => tf.log(...args);
export const exp: typeof tfTypes.exp = (...args) => tf.exp(...args);
export const maximum: typeof tfTypes.maximum = (...args) => tf.maximum(...args);
export const minimum: typeof tfTypes.minimum = (...args) => tf.minimum(...args);
export const clone: typeof tfTypes.clone = (...args) => tf.clone(...args);
export const print: typeof tfTypes.print = (...args) => tf.print(...args);
export const pad: typeof tfTypes.pad = (...args) => tf.pad(...args);
export const notEqual: typeof tfTypes.notEqual = (...args) => tf.notEqual(...args);
export const logicalXor: typeof tfTypes.logicalXor = (...args) => tf.logicalXor(...args);
export const batchNorm: typeof tfTypes.batchNorm = (...args) => tf.batchNorm(...args);
export const localResponseNormalization: typeof tfTypes.localResponseNormalization = (...args) => tf.localResponseNormalization(...args);
export const separableConv2d: typeof tfTypes.separableConv2d = (...args) => tf.separableConv2d(...args);
export const depthwiseConv2d: typeof tfTypes.depthwiseConv2d = (...args) => tf.depthwiseConv2d(...args);
export const conv1d: typeof tfTypes.conv1d = (...args) => tf.conv1d(...args);
export const conv2d: typeof tfTypes.conv2d = (...args) => tf.conv2d(...args);
export const conv2dTranspose: typeof tfTypes.conv2dTranspose = (...args) => tf.conv2dTranspose(...args);
export const conv3d: typeof tfTypes.conv3d = (...args) => tf.conv3d(...args);
export const conv3dTranspose: typeof tfTypes.conv3dTranspose = (...args) => tf.conv3dTranspose(...args);
export const maxPool: typeof tfTypes.maxPool = (...args) => tf.maxPool(...args);
export const avgPool: typeof tfTypes.avgPool = (...args) => tf.avgPool(...args);
export const pool: typeof tfTypes.pool = (...args) => tf.pool(...args);
export const maxPool3d: typeof tfTypes.maxPool3d = (...args) => tf.maxPool3d(...args);
export const avgPool3d: typeof tfTypes.avgPool3d = (...args) => tf.avgPool3d(...args);
export const complex: typeof tfTypes.complex = (...args) => tf.complex(...args);
export const real: typeof tfTypes.real = (...args) => tf.real(...args);
export const imag: typeof tfTypes.imag = (...args) => tf.imag(...args);
export const fft: typeof tfTypes.fft = (...args) => tf.fft(...args);
export const ifft: typeof tfTypes.ifft = (...args) => tf.ifft(...args);
export const rfft: typeof tfTypes.rfft = (...args) => tf.rfft(...args);
export const irfft: typeof tfTypes.irfft = (...args) => tf.irfft(...args);
export const booleanMaskAsync: typeof tfTypes.booleanMaskAsync = (...args) => tf.booleanMaskAsync(...args);
export const randomNormal: typeof tfTypes.randomNormal = (...args) => tf.randomNormal(...args);
export const randomUniform: typeof tfTypes.randomUniform = (...args) => tf.randomUniform(...args);
export const multinomial: typeof tfTypes.multinomial = (...args) => tf.multinomial(...args);
export const randomGamma: typeof tfTypes.randomGamma = (...args) => tf.randomGamma(...args);
