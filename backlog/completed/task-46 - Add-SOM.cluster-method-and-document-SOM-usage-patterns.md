...
- **partialFit() dimension validation**: Added else branch after weight initialization to compare xTensor.shape[1] against weights\_.shape[2]. Error message includes both expected and actual dimensions.
