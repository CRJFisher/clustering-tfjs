...
PCA in src/decomposition: fit/transform/fit*transform/inverse_transform, components*/explained*variance*/mean\_, to_json/from_json, n_components>features throws, fit_predict throws. Shared power_iteration_eig also seeds SOM linear/pca init (no separate impl). sklearn svd_flip fixtures.
