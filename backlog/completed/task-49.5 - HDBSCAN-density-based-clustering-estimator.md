...
HDBSCAN estimator consuming kdistance/mutual*reachability/minimum_spanning_tree/condensation_tree. labels* with -1, probabilities*, exemplar_indices* (store_exemplars), euclidean/manhattan/precomputed. End-to-end parity within tie-tolerance (numpy unstable argsort); exported from init+index.
