...
<!-- SECTION:NOTES:BEGIN -->
condensation_tree.ts: build_single_linkage, condense_hierarchy/build_condensation_tree, compute_stability, excess_of_mass (eom+leaf+epsilon), extract_labels. Validated bit-exact against sklearn's _single_linkage_tree_ hierarchy; degenerate inputs finite.
<!-- SECTION:NOTES:END -->
