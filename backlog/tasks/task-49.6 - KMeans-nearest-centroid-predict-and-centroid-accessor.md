...
<!-- SECTION:NOTES:BEGIN -->
KMeans.predict(X) (nearest centroid via pairwise_distance_matrix, metric-aware) and get_centroids(); throw before fit. sklearn cluster_centers_ + predict fixtures (generate_kmeans.py).
<!-- SECTION:NOTES:END -->
